...
pub mod pallet {
    ...
    impl<T: Config> Pallet<T> {
        ...
        pub fn reg_feed(origin: OriginFor<T>, key: RegStrT, url: RegStrT) -> DispatchResult {
            ...
            // Emit an event.
            Self::deposit_event(Event::RegFeed {
                sender: who,
                key,
                feed,
            });
        ...
        #[pallet::call_index(1)]
        #[pallet::weight(Weight::from_ref_time(10_000) + T::DbWeight::get().reads_writes(1,1))]
        pub fn unreg_feed(origin: OriginFor<T>, key: RegStrT) -> DispatchResult {
            ...
            if feed_exists {
                ...
                Self::deposit_event(Event::UnRegFeed {
                    sender: who,
                    key,
                    feed,
                });
