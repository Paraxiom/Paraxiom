...
export namespace PhatOracle {
    ...
    type PhatOracle_PhatOracle_Error$8 = {
        BadOrigin? : null,
        NotConfigured? : null,
    ...
    type Result$7 = {
        Ok? : never[],
        Err? : PhatOracle_PhatOracle_Error$8
        };
    type Result$6 = {
        Ok? : Result$7,
        Err? : InkPrimitives_LangError$5
    ...
    type PhatOracle_PhatOracle_Deployment$16 = { name: string, owner: InkPrimitives_Types_AccountId$1, contract_id: InkPrimitives_Types_AccountId$1, created_at: number, expired_at: number };
    type Result$15 = {
        Ok? : PhatOracle_PhatOracle_Deployment$16[],
        Err? : PhatOracle_PhatOracle_Error$8
        };
    type Result$14 = {
        Ok? : Result$15,
