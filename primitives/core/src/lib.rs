...
pub type InboundHrmpMessage = polkadot_primitives::InboundHrmpMessage<polkadot_core_primitives::BlockNumber>;
...
pub struct CollationInfoV1 {
	...
	/// New validation code.
	pub new_validation_code: Option<polkadot_parachain::primitives::ValidationCode>,
	/// The number of messages processed from the DMQ.
	pub processed_downward_messages: u32,
	/// The mark which specifies the block number up to which all inbound HRMP messages are processed.
	pub hrmp_watermark: polkadot_core_primitives::BlockNumber,
}
